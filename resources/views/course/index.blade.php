        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">
                    ...
                    @endif
                    <a href="#" class="btn btn-success btn-sm" role="button" aria-pressed="true" data-bs-toggle="modal"
                ...
                <div class="table-responsive">
                    <table class="table datatable table-hover">
                        ...
                        <tbody>
                            ...
                            <div class="modal fade" id="course_delete{{$Dep_Course->id}}" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
